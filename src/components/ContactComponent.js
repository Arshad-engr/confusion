...
import { Breadcrumb, BreadcrumbItem, Button, FormGroup, Col, Form, Label, Input } from 'reactstrap';
                       ...
                       <Form onSubmit={this.handleSubmit}> 
                         ...
                         <FormGroup row>
                              <Label htmlFor="telnum" md={2}>Contact Tel.</Label>
                               <Col md={10}>
                                   <Input type="tel" id="telnum" name="telnum" placeholder="Contact Tel." value={this.state.telnum} onChange={this.handleInputChange} />
                               </Col>
                         </FormGroup>
                         <FormGroup row>
