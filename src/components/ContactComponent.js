...
import { Breadcrumb, BreadcrumbItem, Button, FormGroup, Col, Form, Label, Input, FormFeedback } from 'reactstrap';
...
class  Contact extends Component {
    ...
    validate(firstname, lastname, telnum, email){
        ...
        if(this.state.touched.firstname && firstname.length <3){
            ...
            errors.firstname = 'First Name should be  less or equal to 10 characters';
        }

        if(this.state.touched.lastname && lastname.length <3){
            errors.lastname = 'Last Name should be  greater than 3 characters';
        }else if(this.state.touched.lastname && lastname.length > 10){
            errors.lastname = 'Last Name should be  less or equal to 10 characters';
        }
                       ...
                       <Form onSubmit={this.handleSubmit}> 
                         ...
                         <FormGroup row>
                             <Col md={{size:6,offset:2}}>
                                <FormGroup check>
                                    <Label check>
                                        <Input type="checkbox" name="agree" check={this.state.agree}  onChange={this.handleInputChange}/> {' '}
                                         <strong>May we contact yout ?</strong>
                                    </Label>
                                </FormGroup>
                             </Col>
